...
const PricingPage = () => {
  ...
  const pricingPlans = {
    monthly: [
      { name: t('plan_premium_name'), price: t('plan_premium_price_monthly'), period: t('plan_premium_period_monthly'), features: [t('plan_premium_feature1'), t('plan_premium_feature2'), t('plan_premium_feature3'), t('plan_premium_feature4'), t('plan_premium_feature_flux'), t('plan_premium_feature_seedream')], buttonText: t('plan_premium_button'), isPopular: false, isCustom: false },
    ...
    yearly: [
      { name: t('plan_premium_name'), price: t('plan_premium_price_yearly'), period: t('plan_premium_period_yearly'), features: [t('plan_premium_feature1'), t('plan_premium_feature2'), t('plan_premium_feature3'), t('plan_premium_feature4'), t('plan_premium_feature_flux'), t('plan_premium_feature_seedream')], buttonText: t('plan_premium_button'), isPopular: false, isCustom: false },
